...
import { getUsers, groupByDomain, getTopUsers } from '@/features/user/services/userService';
    ...
    return (
      <Card title="Server-side fetch (shown during page load)">
        <p className={styles.desc}>
          This data is fetched <strong>on the server</strong> with revalidation every 60s.
        </p>
...
export default function ServiceDemoPage() {
  return (
    <div className={styles.page}>
      <h1 className={styles.mainTitle}>SMART GOAL REVIEW 3</h1>
